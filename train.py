...
def train(hyp, opt, device, tb_writer=None):
    ...
    mlc = np.concatenate(dataset.labels, 0)[:, 0].max()  # max label class, 确定有多少个类别
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s6_kpts.yaml', help='model.yaml path')
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[192, 192], help='[train, test] image sizes')
